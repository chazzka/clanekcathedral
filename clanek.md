...
In the article we discussed the difference between outlier and novelty detection, leaning towards the latter.
We analyzed two algorithms for novelty detection, OneLocal Outlier Factor

## References
https://matplotlib.org/stable/users/project/citing.html
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTUxMTY5NjYyNSwxNjAzMTkzMjg4LDI3ND
