...
However, since the Isolation Forest algorithm creates a new separation space based on the previously obtained datapoints, there is not much room for the new, possibly novel datapoint, to be marked so. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTU4MDE5MDA0NiwtMjU1NDUzMTAwLDIwMz
