...
However, since the Isolation Forest algorithm creates a new separation space based on the previously seen datapoints, there is not much room for the new, possibly novel datapoint, to be marked so, since they often fall into the same separation space with the previously seen, regular-marked datapoints.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbODYwNDk0MTM3LC0yNTU0NTMxMDAsMjAzMT
